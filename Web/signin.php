      ...
      <form method="post" action="insert.php">
        <!--name-->
          ...
          <label for="name" class="fl fontLabel"> Name: </label>
    		...
    		<div class="box">
          <label for="admin_no" class="fl fontLabel"> Admission No.: </label>
    			<div class="fl iconBox"><i class="fa fa-user" aria-hidden="true"></i></div>
    			<div class="fr">
    					<input type="text" required name="admin_no" autocomplete="off" 
    		...
    		<div class="box">
          <label for="class" class="fl fontLabel"> Class : </label>
    		...
    		<div class="box">
          <label for="section" class="fl fontLabel"> Section: </label>
    			<div class="fl iconBox"><i class="fa fa-home" aria-hidden="true"></i></div>
    			<div class="fr">
