...
<div class="container">
    ...
    <div class="content">
        <form method="post" action="setevent.php">
        <h1 class="path1">Event</h1>
        <h1 class="update"><?php echo $last_update ?></h1>
        <textarea class="hw" name="ev"><?php echo $text ?></textarea>
        
        </textarea-->
        <div class="options1">
            <ul class="list1">
                <li class="element"><button>Set Event</button></li>
            </ul>
        </div>
        </form>
        <div class="options2">
